...
public class MainActivity extends BridgeActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //
        // Asking in onCreate() raises the system dialog during cold start,
        // before the user has seen a single screen or signed in. That wrecks
        // opt-in rates and reads as a dark pattern to store reviewers.
        //
        // The web layer owns the prompt instead: initializePushNotifications()
