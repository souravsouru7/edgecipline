...
function DashboardContent() {
  ...
  const marketRoutes = isIndianMarket
    ? {
        ...
        checklist: "/checklist",
        intelligence: "/intelligence?market=Indian_Market",
        coach: "/coach",
    ...
    : {
        ...
        analytics: "/analytics",
        checklist: "/checklist",
        intelligence: "/intelligence?market=Forex",
        coach: "/coach",
        reports: "/weekly-reports?market=Forex",
      };
  const currencySymbol = isIndianMarket ? "\u20B9" : "$";
  marketRoutes.onboardingSetup = isIndianMarket
        ...
        <main style={{
            ...
            <div style={{ padding: "18px 22px" }}>
              ...
              <div style={{ height: 220, position: "relative" }}>
                {showSkeleton ? (
                  ...
                  <EquityCurve bull={netPnl >= 0} data={timeline?.buckets} />
                )}
                <EmptyStateOverlay
                  show={showEmptyOverlay}
          ...
          <div className="dashboard-focus-grid" style={{ display: "grid", gridTemplateColumns: "1.35fr 0.65fr", gap: 16, marginBottom: 20 }}>
            ...
            <DashboardPanel
              ...
              accent="#0D9E6E"
              action={<Link href={isIndianMarket ? "/indian-market/analytics/ai-coach" : "/analytics/ai-coach"} style={{ fontSize: 11, fontWeight: 800, color: "#0D9E6E", textDecoration: "none", whiteSpace: "nowrap" }}>View Coaching -&gt;</Link>}
            >
          ...
          <div style={{ marginTop: 20, marginBottom: 20 }}>
            <DashboardPanel
              ...
              accent="#7C3AED"
              action={<Link href={`/psychology-timeline?market=${encodeURIComponent(currentMarket)}`} style={{ fontSize: 11, fontWeight: 800, color: "#7C3AED", textDecoration: "none", whiteSpace: "nowrap" }}>Open Timeline -&gt;</Link>}
            >
